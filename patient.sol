...
contract Patient {
    ...
    mapping(uint256 =>attendant) attendantlist;
     ...
     address public owner;
      ...
      constructor(address _owner) internal  {
        ...
        //   0x87238E12D16FB205d371cb60C8C3A10c6Cd5CFfB;
     ...
     */
     function retreive_patient_details(uint256 patient_id) public view returns (string memory,uint256,string memory,string memory,uint256,string memory,uint256,string memory,uint256){
         patient memory pDetails = patientlist[patient_id];
         
     return (pDetails.patient_name,pDetails.age,pDetails.gender,p.height,pDetails.weight,pDetails.patient_address,pDetails.phone_no,pDetails.email_id,pDetails.date);
     ...
     */
     function retreive_attendant_details(uint256 patient_id) public view returns (string memory,string memory,uint256){
          ...
          attendant memory aDetails = attendantlist[patient_id];
          
      return (aDetails.attendant_name,aDetails.attendant_relation,aDetails.attendant_phn_no);
